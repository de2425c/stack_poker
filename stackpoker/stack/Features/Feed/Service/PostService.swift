...
class PostService: ObservableObject {
    ...
    func createPost(content: String, userId: String, username: String, displayName: String? = nil, profileImage: String?, imageURLs: [String]? = nil, postType: Post.PostType = .text, sessionId: String? = nil, location: String? = nil, isNote: Bool = false) async throws {
